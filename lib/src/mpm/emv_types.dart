...
class ParseEMVQR {
    ...
    while (next(p)) {
      ...
      switch (id) {
        ...
        default:
          ...
          betweenRes = between(
              id,
              UnreservedTemplateID.contextSpecificDataStart,
  ...
  merchantInfoLanguageTemplateToStrng(
    ...
    String languagePreference =
        tlvToString(merchantInfoLang?.languagePreference);
  ...
  Map<String, dynamic> formatCrc(String value) {
    ...
    if (crcValue.err != null) {
      ...
      return {
        "value": format(ID.crc, crcValueString.toUpperCase()),
        "err": null
      };
    }
  }
